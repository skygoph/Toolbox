...
{
    public class EmployeeNoticeController : Controller
    {
        ...
        public ActionResult Upload()
        {
            ...
            ViewBag.noticetype = new SelectList(EmployeeNoticeDAL.GetNoticeType(), "ValueMember", "DisplayMember");
            return View(ntc);
        }
        ...
        public ActionResult SendTo()
        {
            ...
            ViewBag.noticetype = new SelectList(EmployeeNoticeDAL.GetNoticeType(), "ValueMember", "DisplayMember", not.notice.intEmpNoticeType);
        ...
        {
            var data = EmployeeNoticeDAL.GetEmpNoticeList(0);
